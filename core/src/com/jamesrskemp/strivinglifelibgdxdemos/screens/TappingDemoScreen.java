 ...
 */
public class TappingDemoScreen implements Screen {
	private final static String TAG = TappingDemoScreen.class.getName();
	...
	public TappingDemoScreen(final SLDGame game) {
		this.game = game;
